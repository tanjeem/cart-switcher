...
export default function Home() {
  return (
    <main className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-10 py-3.5 bg-white/95 backdrop-blur-md border-b border-gray-100">
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" className="py-28 border-t border-gray-100 bg-[#fafaf9]">
        <div className="max-w-[1280px] mx-auto px-6">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-60px' }} variants={sg}>
            <motion.div variants={up} className="max-w-xl mb-16">
                  ...
                  <div className="relative">
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <div className="w-6 h-6 rounded-full flex items-center justify-center text-white text-[10px] font-black flex-shrink-0"
                        style={{ backgroundColor: G }}>{item.n}</div>
                    </div>
                    <h3 className="font-bold text-gray-900 text-lg mb-2 tracking-tight">{item.title}</h3>
                    <p className="text-gray-500 text-sm leading-relaxed">{item.body}</p>
                  </div>
                  {i < 2 && (
                    <div className="hidden md:flex absolute -right-3 top-10 z-10 w-6 h-6 rounded-full bg-white border border-gray-200 shadow-sm items-center justify-center">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-60px' }} variants={sg}>
            ...
            <motion.div variants={up} className="grid md:grid-cols-4 gap-4 items-start">
              ...
              <div className="p-6 rounded-2xl border-2 border-gray-100 flex flex-col">
                ...
                <div className="flex items-baseline gap-1 mb-1">
                  <span className="text-[40px] font-black text-gray-900 tracking-tight leading-none">$249</span>
                  <span className="text-gray-400 text-sm">one-time</span>
                </div>
